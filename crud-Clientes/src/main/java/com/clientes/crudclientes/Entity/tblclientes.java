...
public class tblclientes {
    ...
    public tblclientes(Integer id_cliente, String clinombre, String cliapellido, String clicorreo, String clidireccion, String clitelefono, String clidescripcion) {
